...
| `minecraft-eaglercraft-ir` | [minecraft-eaglercraft-ir](https://github.com/centralmacatuba/minecraft-eaglercraft-ir) | `centralmacatuba-servicos-jogos-minecraft-eaglercraft-ir` |
| `minecraft-eaglercraft` | [minecraft-eaglercraft](https://github.com/centralmacatuba/minecraft-eaglercraft) | `centralmacatuba-servicos-jogos-minecraft-eaglercraft` |
| `minecraft-jsminecraft` | [minecraft-jsminecraft](https://github.com/centralmacatuba/minecraft-jsminecraft) | `centralmacatuba-servicos-jogos-minecraft-jsminecraft` |
| `minecraft-mcraft` | [minecraft-mcraft](https://github.com/centralmacatuba/minecraft-mcraft) | `centralmacatuba-servicos-jogos-minecraft-mcraft` |
| `minecraft-pixel` | [minecraft-pixel](https://github.com/centralmacatuba/minecraft-pixel) | `centralmacatuba-servicos-jogos-minecraft-pixel` |
| `minecraft-webwasm` | [minecraft-webwasm](https://github.com/centralmacatuba/minecraft-webwasm) | `centralmacatuba-servicos-jogos-minecraft-webwasm` |
